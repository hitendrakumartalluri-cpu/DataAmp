.PHONY: dev test compose-up compose-full compose-down lab-catalogue-test lab-hcp-ingest-test lab-s3-interop-test lab-package-placement-test lab-native-version-test lab-response-policy-test lab-migration-hydration-test lab-beta5-readiness lab-acceptance
